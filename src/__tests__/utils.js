...
test('resolveGsmlgScripts resolves to src/index.js when in the gsmlg-scripts package', () => {
  mockPkg({package: {name: 'gsmlg-scripts'}});
  expect(require('../utils').resolveGsmlgScripts()).toBe(
